document.addEventListener('DOMContentLoaded', () => {
    ...
    const table = $('#tabela').DataTable({
        ...
        ajax: async (data, callback) => {
            ...
            try {
                ...
                const response = await window.electronAPI.searchSupplier(filter);
        ...
        columns: [
            ...
            { data: 'contact_name', title: 'Nome do Contato' },
    ...
    cadastroButton.addEventListener('click', async () => {
        try { await window.electronAPI.openPage('fornecedor.html'); } catch (e) { console.error(e); }
    });
});
